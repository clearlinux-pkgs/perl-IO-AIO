...
Source0  : https://cpan.metacpan.org/authors/id/M/ML/MLEHMANN/IO-AIO-4.76.tar.gz
Summary  : unknown
...
%prep
%setup -q -n IO-AIO-4.76
cd %{_builddir}/IO-AIO-4.76
...
cp %{_builddir}/IO-AIO-4.76/COPYING %{buildroot}/usr/share/package-licenses/perl-IO-AIO/9a56f3b919dfc8fced3803e165a2e38de62646e5
if test -f Makefile.PL; then
