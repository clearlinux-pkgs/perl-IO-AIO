...
Source0  : https://cpan.metacpan.org/authors/id/M/ML/MLEHMANN/IO-AIO-4.75.tar.gz
Summary  : unknown
...
%prep
%setup -q -n IO-AIO-4.75
cd %{_builddir}/IO-AIO-4.75
...
cp %{_builddir}/IO-AIO-4.75/COPYING %{buildroot}/usr/share/package-licenses/perl-IO-AIO/9a56f3b919dfc8fced3803e165a2e38de62646e5
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/IO/AIO.pm
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/auto/IO/AIO/AIO.so
